# Case spec (verbatim, RU): Умный подбор подрядчиков (#79-lite)

Source: HackAlem AI track "Креативные индустрии", official case Google Doc. Copied verbatim at 13:20, 23.09.2026.

...
```
 ...
 app/explain.py: объяснения
   ...
   │   и причины их места в выдаче (фрагмент описания, давший баллы; запрошенный язык)
